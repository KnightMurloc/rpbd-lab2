    ...
    public class BankDetailTab : Tab
    {
        class Row : ListBoxRow, IRow
        {
            ...
            public BankDetail Detail
            {
                get
                {
                    Repository.Instance.Refresh(_detail);
                    return _detail;
                }
...
#pragma warning restore 649
        ...
        public bool SettingData(BankDetail detail)
        {
            ...
            City city = Repository.Instance.FindByCondition<City>($"from City c where c.Name = '{CityEntry.Text}'").UniqueResult<City>();
            if (city == null)
            {
                city = new City();
